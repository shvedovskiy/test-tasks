...
describe('tickets action creators', () => {
  describe('sync action creators', () => {
    ...
    it('creates FETCH_NEWS_SUCCESS', () => {
      ...
      expect(actions.ticketsFetchingSuccess(tickets, ids)).toEqual(expectedAction);
    });

    it('creates FETCH_NEWS_FAILURE', () => {
      const errorMessage = 'Fetching error';
      const expectedAction = {
        type: types.FETCH_TICKETS_FAILURE,
        errorMessage,
      };
      expect(actions.ticketsFetchingFailure(errorMessage)).toEqual(expectedAction);
    });

    it('creates BUY_TICKET', () => {
      const expectedAction = {
  ...
  describe('async action creators', () => {
    ...
    it('create FETCH_TICKETS_SUCCESS when fetching tickets has been done', () => {
      ...
      const expectedActions = [
        ...
        actions.ticketsFetchingSuccess({
          '000': {
            id: '000',
            carrier: 'ТК',
            price: '15550',
    ...
    it('create FETCH_TICKETS_FAILURE when fetching tickets has been done with error', () => {
      ...
      const expectedActions = [
        ...
        actions.requestTickets(),
        actions.ticketsFetchingFailure('Fetching error'),
      ];
      const store = mockStore(Immutable({
        tickets: {
          data: {},
